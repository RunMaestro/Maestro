...
export const DEFAULT_SHORTCUTS = {
	...
	// registered UNBOUND (`keys: []`) rather
	// than left out - that keeps them in Settings -> Shortcuts where a user can
	// record their own binding, without Maestro claiming three more default chords
	// nobody asked for. An empty `keys` never matches an event (see isShortcut) and
	// renders as "Not set".
	tileTerminalBelow: {
