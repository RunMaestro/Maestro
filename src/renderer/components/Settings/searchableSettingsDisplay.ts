...
export const DISPLAY_SETTINGS: SearchableSetting[] = [
	...
	{
		id: 'display-agent-task-list-bar',
		tab: 'display',
		tabLabel: 'Display',
		label: 'Agent Task List',
		description:
			"Dock the agent's current checklist in a collapsible bar above the composer instead of only inline in the conversation",
		keywords: [
			'task',
			'tasks',
			'task list',
	...
	{
		id: 'display-agent-task-list-auto-expand',
		tab: 'display',
		tabLabel: 'Display',
		label: 'Auto-Expand Agent Task List',
		description:
			'Open the docked task list to the full checklist each time the agent writes a new one',
		keywords: [
			'task',
			'tasks',
			'task list',
