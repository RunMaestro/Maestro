...
export const GENERAL_SETTINGS: SearchableSetting[] = [
	...
	{
		id: 'general-autorun-checkpoints',
		tab: 'general',
		tabLabel: 'General',
		label: 'Auto Run Checkpoints',
		description:
			'Snapshot the working tree at each Auto Run task boundary so a long playbook can be rewound to any completed step. Off by default. Ref-backed git snapshots, not copies of your files',
		keywords: [
			'autorun',
			'auto run',
			'checkpoint',
