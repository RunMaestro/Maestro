...
export const GENERAL_SETTINGS: SearchableSetting[] = [
	...
	{
		id: 'general-file-preview-mode',
		tab: 'general',
		tabLabel: 'General',
		label: 'Single-click opens files in a preview tab',
		description:
			'VS Code-style preview tabs: a single click in the file tree opens a replaceable preview tab, and the next file you click reuses it. Double-click or edit to keep the tab.',
		keywords: [
			'preview',
			'preview mode',
			'preview tab',
