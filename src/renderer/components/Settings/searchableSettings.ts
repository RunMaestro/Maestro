...
export const ENCORE_SETTINGS: SearchableSetting[] = [
	...
	},
	{
		...
		tab: 'encore',
		tabLabel: 'Plugins',
		label: 'Time-Traveling Stream Rules',
		description:
			"Watch an agent's live output and interrupt the turn with a corrective reminder when it breaks a project rule defined in .maestro/rules",
		keywords: [
			'ttsr',
			'time traveling',
			'stream rules',
