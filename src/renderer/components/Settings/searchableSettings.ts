...
export const GENERAL_SETTINGS: SearchableSetting[] = [
	...
	{
		id: 'general-mobile-devices',
		tab: 'general',
		tabLabel: 'General',
		label: 'Mobile Devices',
		description:
			'Pair your mobile device with Maestro using QR code scanning. Manage paired devices that can access your agents via the Maestro mobile app.',
		keywords: [
			'mobile',
			'devices',
			'phone',
