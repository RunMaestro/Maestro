...
describe('useSessionCrud', () => {
	...
	describe('createNewSession', () => {
		...
		it('rejects duplicate sessions via validation', async () => {
			...
			expect(consoleError).toHaveBeenCalledWith('Session validation failed: Duplicate session');
		...
		it('uses fallback validation message when validation has no error', async () => {
			...
			expect(consoleError).toHaveBeenCalledWith('Session validation failed: null');
			consoleError.mockRestore();
		});
