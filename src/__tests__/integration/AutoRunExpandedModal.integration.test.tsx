...
vi.mock('lucide-react', () => ({
	...
	Maximize2: ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
		<svg data-testid="maximize2-icon" className={className} style={style} />
	),
	...
	HelpCircle: ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
		<svg data-testid="help-circle-icon" className={className} style={style} />
	),
	Wand2: ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
		<svg data-testid="wand2-icon" className={className} style={style} />
	),
	...
	XCircle: ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
		<svg data-testid="x-circle-icon" className={className} style={style} />
	),
}));
...
describe('AutoRunExpandedModal', () => {
	...
	describe('Mode Controls', () => {
		it('should show Edit button as selected when mode is edit', () => {
			...
			expect(editButton).toHaveStyle({ backgroundColor: `${props.theme.colors.accent}30` });
		});
		...
		it('should show Preview button as selected when mode is preview', () => {
			...
			expect(previewButton).toHaveStyle({ backgroundColor: `${props.theme.colors.accent}30` });
		});
	...
	describe('Batch Run State', () => {
		...
		it('should call onOpenMarketplace when Playbook Exchange button is clicked', () => {
