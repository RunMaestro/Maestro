...
describe('CommandInputButtons', () => {
	...
	describe('SendInterruptButton', () => {
		...
		it('renders enabled send mode with pointer affordance', () => {
			render(
				<SendInterruptButton isInterruptMode={false} isSendDisabled={false} onInterrupt={vi.fn()} />
			);
	...
	describe('ExpandedModeSendInterruptButton', () => {
		...
		it('renders full-width enabled send mode with pointer affordance', () => {
			render(
				<ExpandedModeSendInterruptButton
					isInterruptMode={false}
					isSendDisabled={false}
