...
describe('useSymphony integration', () => {
	...
	it('handles registry, state, issue count, issue fetch, and refresh failures', async () => {
		...
		expect(consoleErrorSpy).toHaveBeenCalledWith('Failed to fetch symphony state:', stateError);
		...
		expect(consoleErrorSpy).toHaveBeenCalledWith('Failed to fetch issue counts:', countsError);
		expect(consoleErrorSpy).toHaveBeenCalledWith('Failed to refresh symphony:', refreshError);
		...
		expect(consoleErrorSpy).toHaveBeenCalledWith('Failed to fetch issues:', issuesError);
	...
	it('logs auto-sync failures without throwing', async () => {
		...
		expect(consoleErrorSpy).toHaveBeenCalledWith('Auto-sync failed:', syncError);
	});
