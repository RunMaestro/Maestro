...
describe('ToolCallCard', () => {
	...
	it('expands from the collapsed summary with click and keyboard, then collapses with keyboard', () => {
		...
		const collapsedCard = screen.getByText('Tool: Bash').closest('[role="button"]')!;
		...
		const expandedHeader = screen.getByText('Tool: Bash').closest('[role="button"]')!;
	...
	it('supports mouse expansion and collapse for a tool with only string input', () => {
		...
		fireEvent.click(screen.getByText('Tool: view').closest('[role="button"]')!);
