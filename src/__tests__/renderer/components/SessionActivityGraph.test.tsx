...
describe('SessionActivityGraph', () => {
	// The graph formats tooltip labels with toLocaleDateString() in the
	// system's local timezone, so the fixed `now` above can land on a
	// different calendar day (shifting a bucket's day-range label) unless
	// the timezone is pinned. UTC matches the timestamps this file was
	// authored against.
