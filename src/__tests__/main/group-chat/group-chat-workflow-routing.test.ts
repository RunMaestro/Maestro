...
describe('group-chat workflow routing', () => {
	...
	it('approves a pending workflow, announces stage 1, and gives it to the moderator', async () => {
	...
	it('treats other pending-plan messages as revision feedback', async () => {
	...
	it('cancels a pending workflow without spawning the moderator', async () => {
