 ...
 * given so Claude Code/OpenCode keep their "Plan-Mode" terminology instead of
 * the generic "Read Only" label.
 */
 ...
 * given so Claude Code/OpenCode keep their plan-mode-specific tooltip.
 */
