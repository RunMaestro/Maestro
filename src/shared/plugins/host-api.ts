 ...
 * / `run.completed` + functional `sidebar`/`activity-bar`/`toolbar` uiItem surfaces;
 * 1.4.0 added the `ui:contribute` / `ui:panel` / `ui:render-unsafe` UI capabilities;
 * 1.3.0 added `tools` + `keybindings`; 1.2.0 added `transcripts:read`.) */
