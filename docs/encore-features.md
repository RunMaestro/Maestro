...
| [Concerto](./concerto)               | `Opt+Cmd+V` / `Alt+Ctrl+V`     | Agents answer with something you can look at and click: interactive views on the Concerto stage, plus always-on-top Cadenza HUD cards |
