...
| Area                              |              Current Count |
| --------------------------------- | -------------------------: |
| E2E spec files after batch 44     |                          7 |
| Declared E2E tests after batch 44 |                        255 |
| Last pre-campaign full E2E result |      91 passed, 49 skipped |
| Latest full E2E validation        |     220 passed, 35 skipped |
...
| Auto Run                                                       |             98 |           260 | Existing suite plus deterministic batch document selection, counts, loop configuration, seeded image attachment rendering/lightbox, edit persistence, and external file sync coverage; live-run, upload, and error flows remain |
