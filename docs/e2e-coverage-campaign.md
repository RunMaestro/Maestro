...
| Area                              |              Current Count |
| --------------------------------- | -------------------------: |
| E2E spec files after batch 43     |                          7 |
| Declared E2E tests after batch 43 |                        255 |
| Last pre-campaign full E2E result |      91 passed, 49 skipped |
| Latest full E2E validation        |     218 passed, 37 skipped |
...
| Auto Run                                                       |             96 |           260 | Existing suite plus deterministic batch document selection, counts, loop configuration, and seeded image attachment rendering/lightbox coverage; live-run, upload, error, persistence flows remain |
