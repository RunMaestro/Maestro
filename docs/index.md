...
Run multiple agents in parallel with a Linear/Superhuman-level responsive interface. Maestro detects installed providers at runtime; see [Provider Notes](./provider-notes) for documented provider capabilities and configuration differences.
