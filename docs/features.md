...
> **Note**: Maestro detects the supported provider registry at runtime. See [Provider Notes](./provider-notes) for the current catalog, capability differences, and beta status.
