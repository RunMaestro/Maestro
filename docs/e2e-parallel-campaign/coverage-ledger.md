...
Current active tests: 988
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,037
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |             85 |           160 |        75 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      75 |                        29 |                                    2 | `8bbf419f8`          |
