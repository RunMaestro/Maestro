...
Current active tests: 1013
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,012
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |            110 |           160 |        50 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      50 |                        54 |                                    2 | `b6015f342`          |
