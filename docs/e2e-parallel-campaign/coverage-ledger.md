...
| Settings                                                       | `wizard-settings-prompts` |            100 |           190 |        90 |
...
| Director notes and prompt composer                             | `wizard-settings-prompts` |             23 |            90 |        67 |
...
| `wizard-settings-prompts`  |                     307 |                        65 |                                    1 | `b6d172c41`          |
