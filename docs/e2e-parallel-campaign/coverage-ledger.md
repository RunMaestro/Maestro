...
Current active tests: 983
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,042
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |             80 |           160 |        80 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      80 |                        24 |                                    2 | `9362cf4fc`          |
