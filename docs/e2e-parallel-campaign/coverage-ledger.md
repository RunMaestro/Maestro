...
Current active tests: 1036
Target active tests: 3,025
Remaining matrix-backed active scenarios: 1,989
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |            133 |           160 |        27 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      27 |                        77 |                                    2 | `0cb3fda43`          |
