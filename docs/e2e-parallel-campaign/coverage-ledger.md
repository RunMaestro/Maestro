...
Current active tests: 998
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,027
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |             95 |           160 |        65 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      65 |                        39 |                                    2 | `b4e5f2bca`          |
