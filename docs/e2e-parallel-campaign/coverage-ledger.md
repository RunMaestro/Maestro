...
Current active tests: 993
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,032
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |             90 |           160 |        70 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      70 |                        34 |                                    2 | `750e25fd0`          |
