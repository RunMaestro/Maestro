...
Current active tests: 973
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,052
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |             70 |           160 |        90 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      90 |                        14 |                                    2 | `03961a3e7`          |
