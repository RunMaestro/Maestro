...
Current active tests: 638
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,387

## Matrix

| Surface | Lane | Current Active | Target Active | Remaining |
| --- | --- | ---: | ---: | ---: |
| App shell, layout, sidebars, resizing, focus, global shortcuts | `shell-tabs-command` | 9 | 110 | 101 |
| Agent CRUD and provider setup | `agent-crud-provider` | 56 | 160 | 104 |
| Codex AI terminal workflows | `autorun-ai-terminal` | 29 | 170 | 141 |
| Command terminal workflows | `shell-tabs-command` | 29 | 95 | 66 |
| Tabs and tab overlays | `shell-tabs-command` | 21 | 120 | 99 |
...
| `shell-tabs-command` | 266 | 0 | 0 | pending |
...
No lane branch has been accepted yet.
