...
Current active tests: 978
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,047
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |             75 |           160 |        85 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      85 |                        19 |                                    2 | `ef05abd54`          |
