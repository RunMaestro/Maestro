...
Current active tests: 1018
Target active tests: 3,025
Remaining matrix-backed active scenarios: 2,007
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |            115 |           160 |        45 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      45 |                        59 |                                    2 | `1bd023b7e`          |
