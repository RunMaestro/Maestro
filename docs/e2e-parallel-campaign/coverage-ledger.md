...
Current active tests: 1033
Target active tests: 3,025
Remaining matrix-backed active scenarios: 1,992
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |            130 |           160 |        30 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      30 |                        74 |                                    2 | `230e6e1c3`          |
