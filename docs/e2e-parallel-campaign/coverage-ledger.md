...
Current active tests: 1041
Target active tests: 3,025
Remaining matrix-backed active scenarios: 1,984
...
| Agent CRUD and provider setup                                  | `agent-crud-provider`     |            138 |           160 |        22 |
...
| -------------------------- | ----------------------: | ------------------------: | -----------------------------------: | -------------------- |
| `agent-crud-provider`      |                      22 |                        82 |                                    2 | `e9541b64a`          |
