...
- Files touched:
  - `docs/e2e-parallel-campaign/agents/fixtures-sharding-review.md`
- Shared helpers touched: none. `docs/e2e-parallel-campaign/broadcasts.md` did
  not need an update.
...
- Checks run:
  - `npx prettier --check docs/e2e-parallel-campaign/agents/fixtures-sharding-review.md`
  - `git diff --check`
