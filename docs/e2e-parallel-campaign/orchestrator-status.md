...
Last updated: 2026-06-09 00:39 EDT
...
| `wizard-settings-prompts`  | `codex/e2e-wizard-settings-prompts`  | `Maestro-worktrees/e2e-wizard-settings-prompts`  | `maestro-e2e-wizard-settings-prompts-campaign-goal` | manual fallback accepted   | 264 active scenarios accepted; 108 remain       |
...
- `wizard-settings-prompts` merged through `6f74ecab0`.
...
- The first recovery tranche is accepted for every lane, and the second through
  ...
  thirty-eighth `wizard-settings-prompts` director-detail, and thirty-ninth
  `wizard-settings-prompts` director-navigation fallbacks are accepted for selected
