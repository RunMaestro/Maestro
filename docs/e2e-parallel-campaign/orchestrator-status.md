...
Last updated: 2026-06-09 00:42 EDT
...
| `wizard-settings-prompts`  | `codex/e2e-wizard-settings-prompts`  | `Maestro-worktrees/e2e-wizard-settings-prompts`  | `maestro-e2e-wizard-settings-prompts-campaign-goal` | manual fallback accepted   | 272 active scenarios accepted; 100 remain       |
...
- `wizard-settings-prompts` merged through `fe2984fae`.
...
- The first recovery tranche is accepted for every lane, and the second through
  ...
  `wizard-settings-prompts` director-navigation, and fortieth
  `wizard-settings-prompts` director-filter fallbacks are accepted for selected
