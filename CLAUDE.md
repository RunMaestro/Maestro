...
| Modify Board / add Board feature    | `src/shared/board/`, `src/main/board/` (storage, dispatcher, spawn, worktree, decompose), `src/main/ipc/handlers/board.ts`, `src/renderer/components/BoardModal.tsx`, `src/cli/commands/board.ts` - see [BOARD.md](docs/agent-guides/BOARD.md)                   |
| Modify Agent Profiles               | `src/shared/profiles/types.ts`, `src/main/profiles/profile-storage.ts`, `src/main/ipc/handlers/profiles.ts`, `src/renderer/components/ProfilesModal/`, `src/cli/commands/profile.ts` - see [BOARD.md](docs/agent-guides/BOARD.md)                                |
