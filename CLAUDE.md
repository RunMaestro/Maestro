...
- **Markdown tasks:** `getMarkdownLines()`, `countUncheckedMarkdownTasks()`, `countCheckedMarkdownTasks()`, `countMarkdownTasks()`, `extractUncheckedMarkdownTasks()`, `uncheckAllMarkdownTasks()` in `src/shared/markdownTasks.ts`
