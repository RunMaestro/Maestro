...
| Modify Board / add Board feature    | `src/shared/board/`, `src/main/board/` (storage, dispatcher, spawn, decompose), `src/main/ipc/handlers/board.ts`, `src/renderer/components/BoardModal.tsx`, `src/cli/commands/board.ts` - see [BOARD.md](docs/agent-guides/BOARD.md)                              |
