...
- [x] Support MailTo
  - Added a `mailto` scheme handler with RFC 6068-style `to`, `subject`, `body`, and custom header parsing/serialization.
- [x] Be 100% iso compatible with uri-js
  - Verified the existing uri-js compatibility fixture suite: 49 parse cases and 17 serialize cases pass, with the known invalid `//10.10.000.10` case intentionally skipped.
