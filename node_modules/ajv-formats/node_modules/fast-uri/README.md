...
- [x] Support MailTo
  - Added `mailto` parsing and serialization support for recipients, `subject`, `body`, and custom headers.
- [x] Be 100% iso compatible with uri-js
  - Enabled the mailto entries in the uri-js compatibility fixture suite.
  - Matched uri-js handling of Unicode mailto domains by normalizing them to ASCII IDN output unless Unicode support is requested.
