...
This playbook covers all **120** accepted priorities exactly once. The priority number is the stable cross-reference to `dedup-report.md`; line numbers and source paths may drift.
...
Total implementation priorities: **120**. Partition invariant: no missing or duplicate priority numbers.
...
5. If priorities move between stages, update this index and prove the 1-120 partition remains complete and duplicate-free.
